...
{
    public bool ShouldRender<TValue>(IEnumerable<TValue> enumerable) => enumerable.Any() ? true : throw new MarkdownDocumentBuilderException(MarkdownDocumentBuilderErrorCode.ProvidedEnumerableIsEmpty);
}
